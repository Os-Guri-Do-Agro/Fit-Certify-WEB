      ...
      <div>
        <nav class="flex gap-[32px] lg:gap-[44px] items-center justify-center relative">
          ...
          <ul class="hidden lg:flex gap-[32px] items-center justify-center flex-wrap">
            <li><a class="text-[0.9rem] font-[500] text-neutral-500 hover:text-cyan-400 duration-300" href="#">Home</a></li>
            <li><a class="text-[0.9rem] font-[500] text-neutral-500 hover:text-cyan-400 duration-300" href="#">Quem Somos</a></li>
            <li><a class="text-[0.9rem] font-[500] text-neutral-500 hover:text-cyan-400 duration-300" href="#">Certificados</a></li>
            <li><a class="text-[0.9rem] font-[500] text-neutral-500 hover:text-cyan-400 duration-300" href="#">Eventos</a></li>
            <li><a class="text-[0.9rem] font-[500] text-neutral-500 hover:text-cyan-400 duration-300" href="#">Marcadores</a></li>
            <li><a class="text-[0.9rem] font-[500] text-neutral-500 hover:text-cyan-400 duration-300" href="#">Artigos</a></li>
            <li><a class="text-[0.9rem] font-[500] text-neutral-500 hover:text-cyan-400 duration-300" href="#">Marketplace</a></li>
          </ul>

          
          <div class="hidden md:flex lg:flex gap-[10px] lg:gap-[32px] md:flex-col lg:flex-row">
            <a href="#" class="flex items-center justify-center w-[130px] h-[40px] rounded-[6px] border border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-white duration-300 text-[0.9em] font-[500]">
              Login
            </a>
            <a href="#" class="flex justify-center items-center w-[130px] h-[40px] rounded-[6px] bg-cyan-400 hover:bg-cyan-500 duration-300 text-white text-[0.9em] font-[500]">
              Cadastro
            </a>
          </div>
          ...
          <transition name="fade">
            <div
              v-if="menuOpen"
              class="absolute top-[60px] right-0 w-[250px] bg-white shadow-lg rounded-md p-6 flex flex-col gap-4 lg:hidden z-50"
            >
