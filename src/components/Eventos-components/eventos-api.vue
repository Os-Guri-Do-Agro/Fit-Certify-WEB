  ...
  >
    ...
    <template v-else>
      <div
        ...
        v-for="item in filteredEventos.slice(0, 15)"
        :key="item.id"
      >
    ...
    <template v-else>
      ...
      >
        <div
          ...
          v-for="item in filteredEventos.slice(0, 5)"
          :key="item.id"
        >
