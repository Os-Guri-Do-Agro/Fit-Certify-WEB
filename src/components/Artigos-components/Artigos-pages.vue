<template>
  <div>
    ...
    <div class="flex items-center md:justify-center gap-4 mt-6 flex-col md:flex-row mt-10 md:mt-20">
      ...
      <span class="flex items-center hidden md:flex text-cyan-400"> {{ currentPage }} - {{ totalPages }}</span>
