/** Parâmetros UTM padrão de campanha (marketing). */
...
export type StoredUtms = {
  /** Primeira campanha que trouxe o visitante (first-touch). */
  first: UtmParams
  /** Última campanha na URL (last-touch). */
  last: UtmParams
...
/** Captura UTMs da URL e persiste (sobrevive à navegação entre páginas). */
...
/** UTMs last-touch em campos planos para o webhook. */
