    ...
    <div class="container flex flex-col items-center">
      <div class="flex flex-col text-center gap-5 w-full items-center">
        ...
        <div class="flex gap-5 flex-col md:flex-row w-full md:justify-center items-center">
          <Categoria v-model:categoria="categoriaSelecionada" />
          <Preço v-model:preco="precoSelecionado" />
          <Condicao v-model:condicao="condicaoSelecionada" />
        </div>

        <div class="w-full mt-5">
          <!-- 👇 agora Produtos recebe os filtros -->
          <Produtos
