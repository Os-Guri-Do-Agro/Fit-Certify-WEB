<template>
    ...
    <div class="bg-white rounded-4xl p-2 md:p-8 max-w-md w-full text-center relative pt-16 pb-8 my-15 border-2 border-gray-200">
    ...
    <a href="https://fitcertify365.com/#/" target="_blank" class="absolute -bottom-6 left-1/2 transform -translate-x-1/2 bg-sky-500 text-white px-6 py-3 rounded-full font-semibold shadow hover:bg-sky-600 transition cursor-pointer text-[0.85em] md:text-[1em] w-full max-w-[60%] duarion-300">
    ACESSE NOSSO SITE
    </a>
    ...
    <div class="flex flex-wrap justify-center gap-3 mt-6 text-3xl">
        ...
        <a href="https://www.facebook.com/profile.php?id=61581850576820" target="_blank" class="bg-blue-500 w-15 h-15 rounded-4xl flex items-center justify-center hover:-translate-y-3 duration-300">
