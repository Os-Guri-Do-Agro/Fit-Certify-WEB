<template>
  <section class="bg-[url('/src/assets/home-imgs/banner-home.jpg')] w-full h-auto md:h-[419px] lg:h-[760px] bg-cover bg-no-repeat bg-right flex justify-center items-center p-10">
    <div class="container flex">
      <div class="flex flex-col text-start max-w-[792px] gap-[18px] lg:gap-[48px]">
        ...
        >
          A FitCertify365 conecta atletas e médicos parceiros. Após uma consulta presencial, o médico emite seu certificado, que fica salvo na plataforma, pronto para ser usado em diferentes provas — com templates personalizados e validade definida pelo profissional.
        </p>
  ...
  <section class="w-full flex justify-center min-h-[350px] bg-cyan-400">
            <div class="container flex items-center justify-center flex-col md:flex-row md:p-10 lg:p-0">
                <div class="flex flex-col items-center justify-center w-1/2 h-[209px] text-center gap-[11px]">
                    ...
                    <span class="text-[1em] lg:text-[1.5em] font-[400] max-w-[256px] xl:max-w-[453.2px] text-white ">
                ...
                <div class="flex flex-col items-center justify-center w-1/2 h-[209px] text-center gap-[11px]">
                    ...
                    <span class="text-[1em] lg:text-[1.5em] font-[400] max-w-[256px] xl:max-w-[443.2px] text-white ">
                ...
                <div class="flex flex-col items-center justify-center w-1/2 h-[209px] text-center gap-[11px]">
                    ...
                    <span class="text-[1em] lg:text-[1.5em] font-[400] w-full max-w-[256px] xl:max-w-[443.2px] text-white mb-[32px] md:mb-0">
  ...
  <section class="w-full flex flex-col">
    ...
    <div class="flex conteiner flex-col items-center md:items-stretch md:flex-row h-auto md:h-[383px] lg:h-[480px]">
      ...
      <div class="md:w-1/2 md:h-auto flex flex-col lg:items-center justify-center gap-[24px] p-10">
        ...
        <section class="w-full md:pt-[52px] lg:pt-[72px] flex items-center justify-center bg-sky-50">
            <div class=" w-full container md:p-10 lg:p-20 flex ">

                <div class="w-full flex flex-col items-center justify-center gap-[32px] ">

                    <div class="flex flex-col justify-center items-center text-center gap-[16px] p-[10px] mt-[43px] md:mt-0">
                        <h2 class="text-[1.875em] md:text-[2.25em] lg:text-[2.75em] xl:text-[3em] font-[600] italic text-cyan-400 md:max-w-[768px] lg:max-w-[1392px] lg:mt-[32px]">
